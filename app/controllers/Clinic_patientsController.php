...
class Clinic_patientsController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("full_names","address","gender","birthdate","register_observations","referred","diseases","phone_patient","manager","register_date","update_date","id_user","id_status","email","id_document_type","document_number","occupation","allergies","emergency_contact_phone","id_blood_type");
