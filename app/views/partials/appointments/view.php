...
$can_view = ACL::is_allowed("appointments/view");
$can_delete = ACL::is_allowed("appointments/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">View  Appointments</h4>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-id_appointment">
                                        <th class="title"> Id Appointment: </th>
                                        <td class="value"> <?php echo $data['id_appointment']; ?></td>
                                    </tr>
                                    ...
                                    <tr  class="td-motive">
                                        ...
                                        <td class="value"> <?php echo $data['motive']; ?></td>
                                    </tr>
                                    <tr  class="td-descritption">
                                        <th class="title"> Descritption: </th>
                                        <td class="value"> <?php echo $data['descritption']; ?></td>
                                    </tr>
                                    <tr  class="td-historial">
                                        <th class="title"> Historial: </th>
                                        <td class="value"> <?php echo $data['historial']; ?></td>
                                    </tr>
                                    <tr  class="td-appointment_date">
                                        <th class="title"> Date: </th>
                                        <td class="value"> <?php echo $data['appointment_date']; ?></td>
                                    </tr>
