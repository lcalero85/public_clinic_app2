...
$can_add = ACL::is_allowed("invoice_cancelled/add");
$can_edit = ACL::is_allowed("invoice_cancelled/edit");
$can_view = ACL::is_allowed("invoice_cancelled/view");
$can_delete = ACL::is_allowed("invoice_cancelled/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Invoice Cancelled</h4>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('invoice_cancelled'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('invoice_cancelled'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="invoice_cancelled-list-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-total_invoice"> Total Invoice</th>
                                                <th  class="td-date_invoice"> Date Invoice</th>
