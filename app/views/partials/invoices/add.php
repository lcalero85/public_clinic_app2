...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Add New Invoices</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="invoices-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("invoices/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <select required=""  id="ctrl-id_concept" name="id_concept"  placeholder="Select a value ..."    class="custom-select" >
                                                    ...
                                                    $value = (!empty($option['value']) ? $option['value'] : null);
                                                    $label = (!empty($option['label']) ? $option['label'] : $value);
                                                    $selected = $this->set_field_selected('id_concept',$value, "");
                                                    ?>
                                                    <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                                        <?php echo $label; ?>
                                                    </option>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <textarea placeholder="Enter Comments" id="ctrl-comments"  required="" maxlength="255" rows="5" name="comments" class=" form-control"><?php  echo $this->set_field_value('comments',""); ?></textarea>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-quantity"  value="<?php  echo $this->set_field_value('quantity',""); ?>" type="number" placeholder="Enter Quantity" max="100" step="1"  required="" name="quantity"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-price"  value="<?php  echo $this->set_field_value('price',""); ?>" type="number" placeholder="Enter Price" max="100" step="0.1"  required="" name="price"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-total_invoice"  value="<?php  echo $this->set_field_value('total_invoice',""); ?>" type="number" placeholder="Enter Total " max="100" step="0.1"  required="" name="total_invoice"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                ...
                                                                $value = (!empty($option['value']) ? $option['value'] : null);
                                                                $label = (!empty($option['label']) ? $option['label'] : $value);
                                                                $checked = $this->set_field_checked('id_invoice_status', $value, "");
                                                                ?>
