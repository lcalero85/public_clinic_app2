...
$can_add = ACL::is_allowed("Myappointments/add");
$can_edit = ACL::is_allowed("Myappointments/edit");
$can_view = ACL::is_allowed("Myappointments/view");
$can_delete = ACL::is_allowed("Myappointments/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">My Appointments
                    </h4>
                </div>
                        ...
                        <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                            <ul class="breadcrumb m-0 p-1">
                                ...
                                <li class="breadcrumb-item">
                                    <a class="text-decoration-none" href="<?php print_link('Myappointments'); ?>">
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn page-content">
                        <div id="Myappointments-list-records">
                                ...
                                <table class="table  table-striped table-sm text-left">
                                    <thead class="table-header bg-light">
                                        <tr>
                                            ...
                                            <th  class="td-appointment_date"> Appoitment</th>
                                            <th  class="td-register_date"> Register</th>
                                            <th  class="td-full_names"> Doctor</th>
                                        </tr>
                                    </thead>
                                    <?php
                                    if(!empty($records)){
