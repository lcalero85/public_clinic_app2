...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-03-2023 a las 03:55:40
...
INSERT INTO `clinic_patients` (`id_patient`, `id_user`, `full_names`, `address`, `gender`, `age`, `birthdate`, `register_observations`, `referred`, `phone_patient`, `manager`, `diseases`, `register_date`, `update_date`, `id_status`, `photo`, `email`) VALUES
(1, 1, 'Juan Alberto  Flores', 'Col.El Rosario #56644', 'Male', '38', '1985-01-03', 'the patient has fever and cough', 'hospital x', '75760539', 'Juan Flores', 'the patient has fever and cough', '2023-02-28', '2023-02-28', 1, 'http://localhost/clinic/uploads/files/satmd1i3yrbqgc8.png', 'test35@gmail.com'),
(2, 4, 'Marvin Gomez', NULL, '', '', '0000-00-00', '', '', '75053691', '', '', '0000-00-00', '0000-00-00', 1, '', 'luiscalero345@gmail.com');
...
INSERT INTO `doc` (`id`, `full_names`, `address`, `birthdate`, `gender`, `age`, `Speciality`, `register_date`, `update_date`, `id_user`, `photo`) VALUES
(1, 'Juan Jose Gomez', 'San Miguel', '1985-01-03 12:00:00', 'Male', '38', 'Cirujano', '2023-02-28 21:46:32', '2023-02-28 21:46:32', 1, 'http://localhost/clinic/uploads/files/a4ynmqexiurv01s.png');
...
(1, 'Juan Perez', 'Admin', 'juanp10', '$2y$10$lsH0i8jgF5Vauv27XhKgR.FpCkjreUdxzqg2qAbrGOUbX2Izh.fLW', 'juanp10@gmail.com', 'http://localhost/clinic/uploads/files/aq128i960fhrw4x.png', '2021-04-27 17:52:59', '2021-04-27 17:52:59', NULL, NULL, '2021-07-27 00:00:00', NULL, ''),
(2, 'Ricardo Castro', 'Assistant', 'rikicastro10', '$2y$10$/ldLSHnmOgwQYh3b9TBWx.a6QP13NoglynmhMk/Z1enpe8D295kRm', 'rikicastro@gmail.com', 'http://localhost/clinic/uploads/files/siczpj2tqh783w1.png', '2021-04-27 17:52:59', '2021-04-27 17:52:59', NULL, NULL, '2021-07-27 00:00:00', NULL, ''),
(3, 'Marlon Gomes', 'Doctor', 'margomes', '$2y$10$C9TA.jSae4I6V.LLGUzEzukX0XpX3DhhZmD1EaV3QmFS9SViwckTi', 'margomez@gmail.com', 'http://localhost/clinic/uploads/files/nmiewrys9ubzpt5.png', '2023-02-28 21:20:52', '2023-02-28 21:20:52', NULL, NULL, '2021-07-27 00:00:00', NULL, ''),
(4, 'Marvin Gomez', 'Patients', 'marvgo', '$2y$10$5aM92DfGbs8QK3Y8BxnShuD9m.g9j7xL39CMFGcTLD71YTo074cO2', 'luiscalero345@gmail.com', 'http://localhost/clinic/uploads/files/qmpc9b6wx4hgkf5.png', '2023-02-28 21:08:37', '2023-02-28 21:08:37', NULL, NULL, '2021-07-27 00:00:00', NULL, '75053691');
